...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('classes', '0004_auto_20210412_1704'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='class',
            name='one_entry_price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='KZT', max_digits=10, verbose_name='One Entry Price'),
        ),
        migrations.AddField(
            model_name='class',
            name='one_entry_price_currency',
        ...
        migrations.AddField(
            model_name='classlog',
            name='end_time',
            field=models.TimeField(default=datetime.time(18, 0), verbose_name='End time'),
        ),
        migrations.AddField(
            model_name='classlog',
            name='one_entry_price',
        ...
        migrations.AddField(
            model_name='classlog',
            name='weekday',
            field=models.PositiveSmallIntegerField(choices=[(1, 'Monday'), (2, 'Tuesday'), (3, 'Wednesday'), (4, 'Thursday'), (5, 'Friday'), (6, 'Saturday'), (7, 'Sunday')], default=1, verbose_name='Weekday'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='classschedule',
            name='weekday',
            field=models.PositiveSmallIntegerField(choices=[(1, 'Monday'), (2, 'Tuesday'), (3, 'Wednesday'), (4, 'Thursday'), (5, 'Friday'), (6, 'Saturday'), (7, 'Sunday')], verbose_name='Weekday'),
        ),
    ]
